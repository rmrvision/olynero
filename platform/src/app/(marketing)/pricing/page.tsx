    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                {/* Starter Plan */}
                <div className="rounded-3xl border border-white/10 bg-white/5 p-8 flex flex-col hover:border-white/20 transition-colors">
                    <div className="size-12 rounded-xl bg-green-500/10 flex items-center justify-center text-green-400 mb-4">
                        <Zap className="size-6" />
                    </div>
                    <h3 className="text-xl font-semibold mb-2 text-white">Стартовый</h3>
                    ...
                    <Link href="/register"><Button variant="outline" className="w-full rounded-full border-white/10 hover:bg-white/10 text-white group">
                        Начать бесплатно <ArrowRight className="ml-2 size-4 group-hover:translate-x-0.5 transition-transform" />
                    </Button></Link>
                </div>

                {/* Pro Plan */}
                <div className="rounded-3xl border border-indigo-500/50 bg-white/5 p-8 flex flex-col relative shadow-2xl shadow-indigo-500/10 hover:border-indigo-500/70 transition-colors">
                    ...
                    <div className="size-12 rounded-xl bg-indigo-500/20 flex items-center justify-center text-indigo-400 mb-4">
                    ...
                    <Link href="/register"><Button className="w-full rounded-full bg-white text-black hover:bg-white/90 font-medium group">
                        Попробовать Про <ArrowRight className="ml-2 size-4 group-hover:translate-x-0.5 transition-transform" />
                    </Button></Link>
                </div>

                {/* Enterprise Plan */}
                <div className="rounded-3xl border border-white/10 bg-white/5 p-8 flex flex-col hover:border-white/20 transition-colors">
                    <div className="size-12 rounded-xl bg-amber-500/10 flex items-center justify-center text-amber-400 mb-4">
