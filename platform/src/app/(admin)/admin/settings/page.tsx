            ...
            <div className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <Card className="border-white/10 bg-white/5">
                        ...
                        <CardContent>
                            <div className="text-sm font-mono text-white">{dbVersion}</div>
                        </CardContent>
                    </Card>
                    <Card className="border-white/10 bg-white/5">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                        ...
                        <span className="text-sm font-medium font-mono text-white">Next.js 16</span>
                    </div>
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                        <span className="text-sm text-neutral-400">ORM</span>
                        <span className="text-sm font-medium font-mono text-white">Prisma 5</span>
                    </div>
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                        <span className="text-sm text-neutral-400">Аутентификация</span>
                        <span className="text-sm font-medium font-mono text-white">NextAuth v5</span>
                    </div>
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                        <span className="text-sm text-neutral-400">Среда</span>
                        <span className="text-sm font-medium font-mono text-white">{process.env.NODE_ENV}</span>
                    </div>
                </div>
            </section>
        </div>
