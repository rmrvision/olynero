...
import { ArrowLeft, MessageSquare, MoreHorizontal, Shield, UserX, UserCheck, Trash2, Mail, Calendar, Clock } from "lucide-react"
    ...
    return (
        <div className="p-6 md:p-8 space-y-6">
            ...
            <div>
                ...
                {user.chats.length === 0 ? (
                    <p className="text-sm text-muted-foreground py-8 text-center border rounded-xl">У этого пользователя нет чатов.</p>
                ) : (
